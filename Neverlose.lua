...
function Neverlose:CreateWindow(config)
    ...
    -- Шапка (Header без системы КФГ)
    local Header = Instance.new("Frame")
    Header.Size = UDim2.new(1, -180, 0, 40)
    ...
    ESPPreviewFrame.Visible = false -- По умолчанию скрыт!
    ...
    function WindowObj:CreateTab(opts)
        ...
        function TabObj:CreateSection(sectionTitle, side)
            ...
            function SectionObj:CreateColorPicker(opts)
                ...
                local color = opts.Default or Color3.fromRGB(0, 145, 255)
                local callback = opts.Callback or function() end
                ...
                ColorBox.MouseButton1Click:Connect(function()
                    if color == Color3.fromRGB(0, 145, 255) then
